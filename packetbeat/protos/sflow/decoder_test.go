...
var TestDecodeSflowDataRaw = []byte{
	0x00, 0x00, 0x00, 0x03, 0x00, 0x00, 0x01, 0x3C, 0x00, 0x01, 0x50, 0xE2, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x41, 0x00, 0x00, 0x4E, 0x20,
...
func Test_decodeSflowData(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			got, err := decodeSflowData(tt.args.r)
			if (err != nil) != tt.wantErr {

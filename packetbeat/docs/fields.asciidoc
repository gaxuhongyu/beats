...
When using sampled NetFlow, the rate at which pacof 100 indicates that one of every 100 packets is sampled
...
[float]
=== `netflow.mpls_top_label_ip_addr`

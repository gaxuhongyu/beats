...
[float]
=== `sample.output_interface_format`
...
[float]
=== `sample.output_interface_value`

type: long

SNMP ifIndex of output interface, 0 if not known. broadcast or multicast are handled as follows:the
first bit indicates multiple destinations, the lower order bits number of interfaces
...
sflow packet data header and raw header decode fields.
...
sflow ethernet frame data decode fields
...
sflow flow sample ipv4 data fields
...
sflow flow sample ipv6 data fields.
...
sflow flow sample extended switch data fields.
...
sflow flow sample extended router data fields.
...
Sflow flow sample extended gateway data +nexthop router ip
...
Sflow flow sample extended user+charset data.
...
Sflow flow sample extended url user+host.
...
Sflow flow sample Extended MPLS Data
...
Sflow flow sample Extended MPLS Tunnel


[float]
=== `mpls_tunnel.tunnel_name_len`
...
Sflow flow sample Extended MPLS VC
...
Sflow flow sample Extended MPLS FEC


[float]
=== `mpls_fec.mpls_ftn_desc_len`
...
Sflow flow sample Extended MPLS LVP FEC


[float]
=== `mpls_lvp_fec.prefix_Length`
...
Sflow flow sample Extended VLAN tunnel


[float]
=== `vlan_tunnel.layer_stack_no`
...
[float]
=== `generic_interface_counters.ifType`
...
[float]
=== `generic_interface_counters.ifDirection`
...
[float]
=== `generic_interface_counters.ifStatus`
...
[float]
=== `generic_interface_counters.ifSpeed`
...
[float]
=== `generic_interface_counters.ifInOctets`
...
[float]
=== `generic_interface_counters.ifInUcastPkts`
...
[float]
=== `generic_interface_counters.ifInMulticastPkts`
...
[float]
=== `generic_interface_counters.ifInBroadcastPkts`
...
[float]
=== `generic_interface_counters.ifInDiscards`
...
[float]
=== `generic_interface_counters.ifInErrors`
...
[float]
=== `generic_interface_counters.ifInUnknownProtos`
...
[float]
=== `generic_interface_counters.ifOutOctets`
...
[float]
=== `generic_interface_counters.ifOutUcastPkts`
...
[float]
=== `generic_interface_counters.ifOutMulticastPkts`
...
[float]
=== `generic_interface_counters.ifOutBroadcastPkts`
...
[float]
=== `generic_interface_counters.ifOutDiscards`
...
[float]
=== `generic_interface_counters.ifOutErrors`
...
[float]
=== `generic_interface_counters.ifPromiscuousMode`
...
[float]
== ethernet_interface_counters fields

sflow counter sample ethernet interface counters, more detail see RFC2358


[float]
=== `ethernet_interface_counters.dot3StatsAlignmentErrors`
...
[float]
=== `ethernet_interface_counters.dot3StatsFCSErrors`
...
[float]
=== `ethernet_interface_counters.dot3StatsSingleCollisionFrames`
...
[float]
=== `ethernet_interface_counters.dot3StatsMultipleCollisionFrames`
...
[float]
=== `ethernet_interface_counters.dot3StatsSQETestErrors`
...
[float]
=== `ethernet_interface_counters.dot3StatsDeferredTransmissions`
...
[float]
=== `ethernet_interface_counters.dot3StatsLateCollisions`
...
[float]
=== `ethernet_interface_counters.dot3StatsExcessiveCollisions`
...
[float]
=== `ethernet_interface_counters.dot3StatsInternalMacTransmitErrors`
...
[float]
=== `ethernet_interface_counters.dot3StatsCarrierSenseErrors`
...
[float]
=== `ethernet_interface_counters.dot3StatsFrameTooLongs`
...
[float]
=== `ethernet_interface_counters.dot3StatsInternalMacReceiveErrors`
...
[float]
=== `ethernet_interface_counters.dot3StatsSymbolErrors`
...
[float]
== token_ring_counters fields

sflow counter sample token ring counters, more detail see RFC1748

[float]
=== `token_ring_counters.dot5StatsLineErrors`
...
[float]
=== `token_ring_counters.dot5StatsACErrors`
...
[float]
=== `token_ring_counters.dot5StatsAbortTransErrors`
...
[float]
=== `token_ring_counters.dot5StatsInternalErrors`
...
[float]
=== `token_ring_counters.dot5StatsLostFrameErrors`
...
[float]
=== `token_ring_counters.dot5StatsReceiveCongestions`
...
[float]
=== `token_ring_counters.dot5StatsFrameCopiedErrors`
...
[float]
=== `token_ring_counters.dot5StatsTokenErrors`
...
[float]
=== `token_ring_counters.dot5StatsSoftErrors`
...
[float]
=== `token_ring_counters.dot5StatsHardErrors`
...
[float]
=== `token_ring_counters.dot5StatsSignalLoss`
...
[float]
=== `token_ring_counters.dot5StatsTransmitBeacons`
...
[float]
=== `token_ring_counters.dot5StatsRecoverys`
...
[float]
=== `token_ring_counters.dot5StatsLobeWires`
...
[float]
=== `token_ring_counters.dot5StatsBurstErrors`
...
[float]
=== `token_ring_counters.dot5StatsRemoves`
...
[float]
=== `token_ring_counters.dot5StatsSingles`
...
[float]
=== `token_ring_counters.dot5StatsFreqErrors`
...
[float]
== baseVG_interface_counters fields

sflow counter sample 100 BaseVG Interface Counters, more detail see RFC2020

[float]
=== `baseVG_interface_counters.dot12InHighPriorityFrames`
...
[float]
=== `baseVG_interface_counters.dot12InHighPriorityOctets`
...
[float]
=== `baseVG_interface_counters.dot12InNormPriorityFrames`
...
[float]
=== `baseVG_interface_counters.dot12InNormPriorityOctets`
...
[float]
=== `baseVG_interface_counters.dot12InIPMErrors`
...
[float]
=== `baseVG_interface_counters.dot12InOversizeFrameErrors`
...
[float]
=== `baseVG_interface_counters.dot12InDataErrors`
...
[float]
=== `baseVG_interface_counters.dot12InNullAddressedFrames`
...
[float]
=== `baseVG_interface_counters.dot12OutHighPriorityFrames`
...
[float]
=== `baseVG_interface_counters.dot12OutHighPriorityOctets`
...
[float]
=== `baseVG_interface_counters.dot12TransitionIntoTrainings`
...
[float]
=== `baseVG_interface_counters.dot12HCInHighPriorityOctets`
...
[float]
=== `baseVG_interface_counters.dot12HCInNormPriorityOctets`
...
[float]
=== `baseVG_interface_counters.dot12HCOutHighPriorityOctets`
...
[float]
== vlan_counters fields

sflow counter sample VLAN Counters

[float]
=== `vlan_counters.vlan_id`
...
[float]
== processor_information fields

sflow counter sample Processor Information


[float]
=== `processor_information.cpu_5s_percentage`
...
[float]
=== `processor_information.cpu_1m_percentage`
...
[float]
=== `processor_information.cpu_5m_percentage`
...
[float]
=== `processor_information.total_memory`
...
[float]
=== `processor_information.free_memory`
